...
export const zhCNMessages: Record<MessageKey, string> = {
  ...
  "template.field.useInterrupt.hint": "在 char 发言时打断其发言，进行插话",
  "template.field.useBatchInput": "启用批量输入",
  "template.field.useBatchInput.hint": "支持用户批量发言，预输入时 char 不会回话，回复有 3s 延迟",
