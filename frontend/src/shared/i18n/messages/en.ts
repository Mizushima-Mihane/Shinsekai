...
export const enMessages: Record<MessageKey, string> = {
  ...
  "template.field.useInterrupt.hint": "Interrupt the character mid-speech to interject.",
  "template.field.useBatchInput": "Enable batch input",
  "template.field.useBatchInput.hint": "Send several messages in a row; the character won't reply while you're still typing, and replies have a ~3s delay.",
