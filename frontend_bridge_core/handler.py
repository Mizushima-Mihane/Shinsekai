...
class FrontendBridgeHandler(BaseHTTPRequestHandler):
    ...
    def _launch_chat(self, body: dict[str, Any]) -> dict[str, Any]:
        ...
        message = _launch_chat(
            ...
            use_interrupt=bool(body.get("useInterrupt", True)),
            use_batch_input=bool(body.get("useBatchInput", True)),
    ...
    def _resume_last_chat(self) -> dict[str, Any]:
        ...
        message = _launch_chat(
            ...
            use_interrupt=bool(session.get("useInterrupt", True)),
            use_batch_input=bool(session.get("useBatchInput", True)),
